            ...
            <div className="intro">
                ...
                <div className="intro--main">
                    <div className="intro--text">
                        ...
                        <p className="intro--name">I'm <span className="name">Deep Parekh</span>, a student and an aspiring software engineer focused on developing applications that bring a small change in people's lives. </p>
                        <p></p>
                    </div>
